...
import (
	...
	remediationv1alpha1 "github.com/openshift/machine-api-operator/cmd/node-healthcheck/api/v1alpha1"
	"github.com/openshift/machine-api-operator/cmd/node-healthcheck/controllers"
	"github.com/openshift/machine-api-operator/cmd/node-healthcheck/controllers/cluster"
	"github.com/openshift/machine-api-operator/cmd/node-healthcheck/controllers/featuregates"
	"github.com/openshift/machine-api-operator/cmd/node-healthcheck/controllers/initializer"
	"github.com/openshift/machine-api-operator/cmd/node-healthcheck/controllers/mhc"
	"github.com/openshift/machine-api-operator/cmd/node-healthcheck/controllers/utils"
	"github.com/openshift/machine-api-operator/cmd/node-healthcheck/metrics"
	"github.com/openshift/machine-api-operator/cmd/node-healthcheck/version"
)
...
func main() {
	...
	mgr, err := ctrl.NewManager(ctrl.GetConfigOrDie(), ctrl.Options{
		...
		LeaderElectionID:       "e1f13584.machine-api-operator.io",
